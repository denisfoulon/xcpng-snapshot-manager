...
class StorageMaintenanceConfig:
    """Configuration for scheduled Storage Repository maintenance."""

    enabled: bool = False
    mode: str = "audit"
    interval_hours: int = 24
    min_interval_hours: int = 20
    blacklist_sr_uuids: list[str] = field(default_factory=list)
    state_file: str = "state/sr_maintenance.json"
