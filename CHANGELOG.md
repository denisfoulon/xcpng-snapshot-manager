...
- Disabled-by-default SR maintenance (`maintenance.vacuum`).
- Automatic SR discovery with UUID blacklist exclusions.
- Audit, dry-run and execute modes with cooldown and persistent state.
- Xen Orchestra SR scan task execution, timeout handling, serialized execution and before/after free-space recording.
- Configuration and scheduling guidance for cron/systemd.
